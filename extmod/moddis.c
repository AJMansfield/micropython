...
static const mp_rom_obj_tuple_t opname_obj = {
    ...
    .items = {
        ...
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_POSITIVE     ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_POSITIVE     ),
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_NEGATIVE     ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_NEGATIVE     ),
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_INVERT       ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_INVERT       ),
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_NOT          ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_NOT          ),
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_BOOL         ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_BOOL         ),
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_LEN          ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_LEN          ),
        [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_HASH         ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_HASH         ),
        // [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_ABS          ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_ABS          ),
        // [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_INT_MAYBE    ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_INT_MAYBE    ),
        // [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_FLOAT_MAYBE  ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_FLOAT_MAYBE  ),
        // [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_COMPLEX_MAYBE] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_COMPLEX_MAYBE),
        // [MP_BC_UNARY_OP_MULTI + MP_UNARY_OP_SIZEOF       ] = MP_ROM_QSTR(MP_QSTR_UNARY_OP_SIZEOF       ),

        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_LESS                ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_LESS                ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_MORE                ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_MORE                ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_EQUAL               ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_EQUAL               ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_LESS_EQUAL          ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_LESS_EQUAL          ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_MORE_EQUAL          ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_MORE_EQUAL          ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_NOT_EQUAL           ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_NOT_EQUAL           ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_IN                  ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_IN                  ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_IS                  ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_IS                  ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_EXCEPTION_MATCH     ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_EXCEPTION_MATCH     ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_OR          ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_OR          ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_XOR         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_XOR         ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_AND         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_AND         ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_LSHIFT      ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_LSHIFT      ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_RSHIFT      ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_RSHIFT      ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_ADD         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_ADD         ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_SUBTRACT    ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_SUBTRACT    ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_MULTIPLY    ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_MULTIPLY    ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_MAT_MULTIPLY] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_MAT_MULTIPLY),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_FLOOR_DIVIDE] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_FLOOR_DIVIDE),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_TRUE_DIVIDE ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_TRUE_DIVIDE ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_MODULO      ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_MODULO      ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_INPLACE_POWER       ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_INPLACE_POWER       ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_OR                  ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_OR                  ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_XOR                 ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_XOR                 ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_AND                 ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_AND                 ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_LSHIFT              ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_LSHIFT              ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_RSHIFT              ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_RSHIFT              ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_ADD                 ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_ADD                 ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_SUBTRACT            ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_SUBTRACT            ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_MULTIPLY            ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_MULTIPLY            ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_MAT_MULTIPLY        ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_MAT_MULTIPLY        ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_FLOOR_DIVIDE        ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_FLOOR_DIVIDE        ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_TRUE_DIVIDE         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_TRUE_DIVIDE         ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_MODULO              ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_MODULO              ),
        [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_POWER               ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_POWER               ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_DIVMOD              ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_DIVMOD              ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_CONTAINS            ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_CONTAINS            ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_OR          ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_OR          ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_XOR         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_XOR         ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_AND         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_AND         ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_LSHIFT      ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_LSHIFT      ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_RSHIFT      ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_RSHIFT      ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_ADD         ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_ADD         ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_SUBTRACT    ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_SUBTRACT    ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_MULTIPLY    ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_MULTIPLY    ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_MAT_MULTIPLY] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_MAT_MULTIPLY),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_FLOOR_DIVIDE] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_FLOOR_DIVIDE),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_TRUE_DIVIDE ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_TRUE_DIVIDE ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_MODULO      ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_MODULO      ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_REVERSE_POWER       ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_REVERSE_POWER       ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_NOT_IN              ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_NOT_IN              ),
        // [MP_BC_BINARY_OP_MULTI + MP_BINARY_OP_IS_NOT              ] = MP_ROM_QSTR(MP_QSTR_BINARY_OP_IS_NOT              ),
    },
};
